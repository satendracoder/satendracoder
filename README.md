...
- 🎯 Goal: Become **Senior Full Stack Engineer**
...
- Angular + Spring Boot based enterprise application
- Dealer credit approval workflow
- Role based access

### 🔹 Angular UI Library
- Reusable Angular components
- Loader, Toaster, Authentication module
